...
//             StartExperimentResponse start = handler.startExperiment(target, engine);
//             if (start.isPaymentRequired()) {
//                 System.out.println("Payment required. Pay 1 gold? (y/n)");
//                 String pay = scanner.nextLine().trim().toLowerCase();
//                 if (!pay.startsWith("y")) {
//                     handler.cancelExperiment(engine);
//                     System.out.println("Experiment cancelled");
//                     return;
//                 }
//                 StartExperimentResponse paid = handler.payGold(engine);
//                 if (paid.isPaymentRequired()) {
//                     System.out.println("Not enough gold. Experiment cancelled.");
//                     handler.cancelExperiment(engine);
//                     return;
//                 }
//                 start = paid;
...
//             ConductExperimentResponse result = handler.conductExperiment(chosen1, chosen2, engine);
